...
- **Development: Added API debug logging** - Added console logging to show which URL and environment (production vs staging) is being used for API calls, along with the request body for debugging purposes
