...
async function loadLanguageSupport({ lang, customMap } = {}) {
    ...
    return import('../language-support.js');
}
...
describe('language-support', () => {
    ...
    it('merges and uses custom language maps provided by the host site', async () => {
